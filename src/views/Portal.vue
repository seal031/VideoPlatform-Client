  ...
  <div class="portal-wrap">
            ...
            <div>
              <el-carousel trigger="click" height="355px" indicator-position="outside" @change="handleChangeCarousel">
                <el-carousel-item v-for="item in tpxwList" :key="item">
                  <img :src="item.brief_image" style="width: 100%; height: 100%" @click="openNews('/BriefShow',item)" />
                </el-carousel-item>
              </el-carousel>
          ...
          <div>
            ...
            <div v-if="hotVideoList && hotVideoList.length > 0" class="video-wrap">
              <div class="video-item" v-for="(hotvideoitem, i) in hotVideoList.slice(0, 6)" :key="i"
                ...
                <video-item :src="hotvideoitem.video_facede" :title="hotvideoitem.video_title"
    ...
    <div class="portal-system">
      ...
      <div class="portal-system-item portal-system-item4 poi">
        ...
        <h2>
          志愿者23人
          <svg t="16458878359" class="svg-icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
