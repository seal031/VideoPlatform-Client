<template>
    ...
    <div class="portal-wrap width1000">
      ...
      >
        <el-tab-pane>
          <template #label>
            <span><i class="el-icon-date"></i> 图片新闻({{tpxwTotalCount}})</span>
          </template>
        ...
        <el-tab-pane>
          <template #label>
            <span><i class="el-icon-date"></i>通知公告({{tzggTotalCount}})</span>
            <!-- &#12288;&#12288;&#12288;&#12288;&#12288;&#12288; -->
          </template>
          <div class="video-result">
          <div class="tr mb10">
        ...
        <el-tab-pane>
          <template #label>
            <span :icon="Star"><i class="el-icon-date"></i>政策法规({{zcfgTotalCount}})</span>
          </template>
          <div class="video-result">
          <div class="tr mb10">
            <el-pagination
  ...
  export default {
    ...
    setup() {
        ...
        onMounted(() => {
            ...
            videoQuery.params.keyword=keyword;
            tzggQuery.params.keyword=keyword;
            tpxwQuery.params.keyword=keyword;
            zcfgQuery.params.keyword=keyword;
            bindTpxw();
            bindTzgg();
            bindZcfg();
            bindVideoList();
