<template>
  <div>
    <!-- TODO 替换src -->
    <!-- <el-image :src="src"  fit="fill" :itemid="videoId" class="picture"> -->
    <el-image :src="src" fit="fill" :itemid="videoId" class="picture" :title="tip">
      ...
      <div>
        <span>
          <template v-if="isShowCount">
            ...
            <el-icon>
              <svg t="1645883884232" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="2963" width="14" height="14">
                <path
